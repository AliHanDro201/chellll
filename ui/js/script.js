...
//////////////////Отправка на Whisper и далее в GPT/////////////////////////////////////
    async function onRecordingStop() {
        ...
        if (!text.trim()) { // Вместо toggleMic, просто выключаем флаг и обновляем UI:
            micOn = false;
            toggleButton.checked = false;
            stopListener("Переключите микрофон и скажите");
            return; }
        ...
        // голоса браузера больше не озвучиваем
        // if (!resp.gptMessage.includes("{name}")) speakText(resp.gptMessage); // speakText(resp.gptMessage);  // отключили «роботный» голос
...
///////////////////////////////////Чат‑поле без «дублей»//////////////////////////////////////////
    chatInput.addEventListener("keydown", async e => {
        ...
        // speakText(resp.gptMessage);  // Web Speech больше не используем
      });
...
///////////////////////////////////важная  фича//////////////////////////////////////////
      function safeParse(raw) {
        try {
          ...
          // не JSON — вернём в знакомом формате
          return { gptMessage: raw };
        }
      }
